...
const pregaoRoutes              = require('./routes/pregao');
...
app.use('/api/monitor',             autenticar, monitorRoutes);
app.use('/api/pregao',              autenticar, pregaoEstrategiaRoutes);
app.use('/api/pregoes',             autenticar, verificarPermissao('pregoes'), pregaoRoutes);
